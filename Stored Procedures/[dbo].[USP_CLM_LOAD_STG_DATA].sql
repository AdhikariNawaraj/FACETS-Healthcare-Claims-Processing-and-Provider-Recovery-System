...
/****** Object:  StoredProcedure [dbo].[USP_CLM_LOAD_STG_DATA]    Script Date: 8/27/2026 7:18:11 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN TRY
		...
		SET @step_desc = 'GENEREATE UNIQUE CLAIM NUMBER USING SEQUENCE'
		...
		SET @CLCL_ID = RIGHT(YEAR(GETDATE()),2) + LEFT(DATENAME(MONTH,GETDATE()),1) + @VarSeq
